...
#define CUSTOM_MACHINE_NAME "Duplicator4x"
...
//
#define Z_CLEARANCE_DEPLOY_PROBE 15 // Raise to make room for the probe to deploy / stow
#define Z_CLEARANCE_BETWEEN_PROBES 5  // Raise between probing points.
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (120*40)
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {94.14, 93.94, 392, 100, 100}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {200, 200, 8, 200, 200}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {1000, 1000, 10, 3000, 3000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
